...
public class FinalListFragmentTest {

    private FinalListFragment fragment;
    ...
    public void listEntrants_populatesAdapter_whenSnapshotsReturned() throws Exception {
        ...
        FinalListFragment spyFragment = spy(fragment);

        // Provide a mock Context
        Context mockContext = mock(Context.class);
        doReturn(mockContext).when(spyFragment).getContext();

        // 2️⃣ Prepare DataSnapshots for two accepted entrants
        ...
        when(mockEventRef.child("ACCEPTED")).thenReturn(mockStatusRef);
        ...
        m.invoke(spyFragment, EntrantStatus.ACCEPTED);
