...
public class UpdateEventFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        eventButton.setOnClickListener(v ->
                NavHostFragment.findNavController(UpdateEventFragment.this)
                        .navigate(R.id.action_UpdateEventFragment_to_EventFragment)
        );

        createEventButton.setOnClickListener(v ->
                NavHostFragment.findNavController(UpdateEventFragment.this)
                        .navigate(R.id.action_UpdateEventFragment_to_CreateEventFragment)
        );
    }

    /** Utility method to trim a {@link CharSequence}. */
    private static String s(CharSequence cs) {
        return cs == null ? "" : cs.toString().trim();
    }

    /** Displays a short {@link Toast} message in the current context. */
