...
//
        ...
        eventButton.setOnClickListener(v -> {
            NavHostFragment.findNavController(ChosenListFragment.this).navigate(R.id.action_ChosenListFragment_to_EventFragment);
        });
...
//            NavHostFragment.findNavController(UpdateEventFragment.this).navigate(R.id.action_SecondFragment_to_CreateEventFragment);
            ...
            NavHostFragment.findNavController(ChosenListFragment.this).navigate(R.id.action_ChosenListFragment_to_CreateEventFragment);
        });
        ...
        sendNotificationButton.setOnClickListener(v -> {
            ...
            organizer.sendWaitingListNotification("chosen list notification");
            Toast.makeText(requireContext(), "chosen list notfication sent", Toast.LENGTH_SHORT).show();
