...
public class Event {
    ...
    /**
     * Persists this {@code Event} to Firebase under the "Event" root.
     * <p>
     * Behavior:
     * <ol>
     *   <li>Generates a new push key if {@link #id} is null.</li>
     *   <li>Builds a field map according to the current instance values.</li>
     *   <li>Writes the map to <code>/Event/{id}</code> using {@link FirebaseService#addEntry}.</li>
     *   <li>Reinitializes {@link #organizer} with the finalized {@link #id}.</li>
     * </ol>
     * </p>
     */
