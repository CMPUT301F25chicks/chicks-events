...
public class US010601_QRCodeScannerUITest {
     ...
     * 
     * As an entrant, I should be able to click the start scan button
     * to initiate QR code scanning (may require camera permission).
     */
    @Test
    public void entrant_canClickStartScanButton() {
        ...
        // Verify button is clickable and can be clicked
        onView(withId(R.id.btn_start_scan))
            .check(matches(isDisplayed()));
        ...
        // Button should still be accessible (scanner may open or permission dialog may appear)
        // We verify the button was clickable
    }
