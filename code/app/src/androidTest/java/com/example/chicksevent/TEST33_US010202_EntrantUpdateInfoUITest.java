...
@LargeTest
public class TEST33_US010202_EntrantUpdateInfoUITest {
    ...
    public void entrant_canUpdateInfo() {
        ...
        // VERIFY FUNCTIONALITY: Update fields with new values
        ...
        // Verify fields contain updated values
    ...
    /**
     * Test: Entrant can save updated information.
     * VERIFIES FUNCTIONALITY: Actually clicks save button and verifies data is saved.
     */
    @Test
    public void entrant_canSaveUpdatedInfo() {
        navigateToEditScreen();

        // Update fields
        onView(withId(R.id.edit_name)).perform(replaceText("New Updated Name"), closeSoftKeyboard());
        onView(withId(R.id.edit_email)).perform(replaceText("newupdated@example.com"), closeSoftKeyboard());
        onView(withId(R.id.edit_phone)).perform(replaceText("8888888888"), closeSoftKeyboard());

        // VERIFY FUNCTIONALITY: Click save button
        waitForView(withId(R.id.btn_save_info), 5);
        performReliableClick(onView(withId(R.id.btn_save_info)));
        ...
        // VERIFY FUNCTIONALITY: Data is saved (fields still contain updated values)
        onView(withId(R.id.edit_name))
                .check(matches(withText("New Updated Name")));
        onView(withId(R.id.edit_email))
                .check(matches(withText("newupdated@example.com")));
        onView(withId(R.id.edit_phone))
                .check(matches(withText("8888888888")));

        // SUCCESS: User story functionality verified - updated info is saved
    }
